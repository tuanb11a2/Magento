...
class Info extends Template
{
    ...
    // {
    //     $customerData = $this->customerRepositoryInterface->getById($this->getCustomer()->getId());
    //     $value = $customerData->getCustomAttribute('avatar');
    //     $productImage = $this->helper->init($customerData, 'avatar')->setImageFile($value->getValue());
    //     return $productImage;
    // }
